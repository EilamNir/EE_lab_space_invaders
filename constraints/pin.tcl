#============================================================
# set proj_name space_invaders
# file for space invaders project containg VGA and audio pins
#============================================================
...
# SW
#============================================================
set_location_assignment PIN_AB30 -to start_game ; #SW[0]
set_location_assignment PIN_Y27 -to pause ; #SW[1]
...
# LED
#============================================================
# set_location_assignment PIN_AA24 -to lampTest ;#LEDR[0]
